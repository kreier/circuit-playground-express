...
old_value = 0
morse = []
letters = {"A":[1,3],"B":[3,1,1,1],"C":[3,1,3,1],"D":[3,1,1],"E":[1],"F":[1,1,3,1],"G":[3,3,1],"H":[1,1,1,1],"I":[1,1],"J":[1,3,3,3],"K":[3,1,3],"L":[1,3,1,1],"M":[3,3],"N":[3,1],"O":[3,3,3],"P":[1,3,3,1],"Q":[3,3,1,3],"R":[1,3,1],"S":[1,1,1],"T":[3],"U":[1,1,3],"V":[1,1,1,3],"W":[1,3,3],"X":[3,1,1,3],"Y":[3,1,3,3],"Z":[3,3,1,1]}
starttime = 0
stoptime = 0
...
def letter(morselist):
    try:
        a = list(letters.values()).index(morselist)
    except:
        a = 0
    return list(letters.keys())[a]
...
while True:
    ...
    if light_value != old_value:
        if light_value == 1:
            ...
            blanktime = starttime - stoptime
            # end of letter - 3 dots or 1 dash
            if blanktime > DASH:
                # decode the letter
                print(letter(morse), end='')
                morse = []
                if blanktime > SPACE:
                    print(" ", end='')
